package com.pfplaybackend.api.virtualcrew.adapter.in.web;
...
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.AddPackTrackRequest;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.ApplyVirtualCrewConfigRequest;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.AssignPersonaRequest;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.AssignPersonaResponse;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.AvatarCatalogItemResponse;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.BotRosterItemResponse;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.BulkApplyVirtualCrewConfigRequest;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.ChatConfigResponse;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.CreatePersonaRequest;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.CreateSongPackRequest;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.CreatedIdResponse;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.UpdatePersonaRequest;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.DistributeBotAvatarRequest;
...
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.SongPackListItemResponse;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.UnassignPersonaRequest;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.UpdateChatConfigRequest;
import com.pfplaybackend.api.virtualcrew.adapter.in.web.payload.VirtualCrewLiveStatusResponse;
 ...
 *
 * <p>feature-cohesive 배치: administration BC 가 아니라 {@code virtualcrew} feature 의 inbound adapter 에 둔다
 * (송 팩·봇 풀·reconcile 이 모두 이 feature 응집). 공통 {@code @adminAuth.canManageVirtualCrew()} SpEL 로 게이팅하고
...
public class AdminVirtualCrewController {

    private final VirtualCrewAdminService adminService;
    ...
    private final VirtualCrewChatConfigAdminService chatConfigAdminService;
    ...
    @GetMapping("/virtual-crew/music-search")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @GetMapping("/virtual-crew/song-packs")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @GetMapping("/virtual-crew/song-packs/{id}")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @PostMapping("/virtual-crew/song-packs")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @PutMapping("/virtual-crew/song-packs/{id}")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @DeleteMapping("/virtual-crew/song-packs/{id}")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @PostMapping("/virtual-crew/song-packs/{id}/tracks")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @DeleteMapping("/virtual-crew/song-packs/{id}/tracks/{trackId}")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @GetMapping("/virtual-crew/personas")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @GetMapping("/virtual-crew/personas/{id}")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @PostMapping("/virtual-crew/personas")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @PutMapping("/virtual-crew/personas/{id}")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @DeleteMapping("/virtual-crew/personas/{id}")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @PutMapping("/partyrooms/{partyroomId}/virtual-crew")
    public ResponseEntity<Void> applyConfig(@PathVariable("partyroomId") Long partyroomId,
                                            @Valid @RequestBody ApplyVirtualCrewConfigRequest req) {
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @PostMapping("/partyrooms/{partyroomId}/virtual-crew/drain")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @PostMapping("/partyrooms/{partyroomId}/virtual-crew/drain-resources")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @PostMapping("/partyrooms/{partyroomId}/virtual-crew/revive")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @GetMapping("/partyrooms/{partyroomId}/virtual-crew")
    public ResponseEntity<ApiCommonResponse<VirtualCrewLiveStatusResponse>> liveStatus(
            @PathVariable("partyroomId") Long partyroomId) {
        VirtualCrewAdminService.LiveStatus s = adminService.liveStatus(new PartyroomId(partyroomId));
        return ResponseEntity.ok(ApiCommonResponse.success(VirtualCrewLiveStatusResponse.from(s)));
    }
    ...
    public ResponseEntity<Void> applyBulk(@Valid @RequestBody BulkApplyVirtualCrewConfigRequest req) {
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @GetMapping("/virtual-crew/avatar-catalog")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @PutMapping("/virtual-crew/bots/{userId}/avatar")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @PostMapping("/virtual-crew/bots/avatar/distribute")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @PostMapping("/virtual-crew/bots/persona/assign")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @PostMapping("/virtual-crew/bots/persona/unassign")
    ...
    @Operation(summary = "가상 DJ 채팅/자가갱신 설정 조회",
            description = "vcrew.chat.* 5키 + 자가갱신 forward-gate 1키 (system_config, fail-open 폴백)")
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @GetMapping("/virtual-crew/chat-config")
    ...
    @SecurityRequirement(name = "cookieAuth")
    @PreAuthorize("@adminAuth.canManageVirtualCrew()")
    @PutMapping("/virtual-crew/chat-config")
