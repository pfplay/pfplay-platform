...
import com.pfplaybackend.api.virtualcrew.application.service.BotIdentityResolver;
 ...
 *
 * <p>동시성/쿨다운은 방별 단일 게이트 키({@code vcrew:chat:gate:<roomId>})의 SETNX+TTL 로 처리한다.
...
public class BotChatTrigger {
    ...
    public void onChatMessage(ChatMessageDto msg) {
        ...
        String gateKey = "vcrew:chat:gate:" + msg.partyroomId().getId();
