...
public class VirtualCrewEventListener {
    ...
    public void onTerminated(PartyroomTerminatedEvent event) {
        ...
        Optional<PartyroomVirtualCrewConfigData> optConfig = configRepository.findByPartyroomId(partyroomId);
        ...
        log.info("[vcrew-event] PartyroomTerminated → config OFF partyroomId={}", partyroomId);
    }
}
