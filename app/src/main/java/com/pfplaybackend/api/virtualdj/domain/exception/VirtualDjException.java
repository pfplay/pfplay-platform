...
public enum VirtualDjException implements DomainException {
    ...
    INVALID_CONFIG("VDJ-007", "MANAGED 전환에는 targetCount/djBotCount 가 필요합니다", ErrorType.BAD_REQUEST),
    ...
    DJ_COUNT_EXCEEDS_TRACKS("VDJ-014", "djBotCount 가 필터 통과 트랙 수를 초과합니다", ErrorType.BAD_REQUEST);
