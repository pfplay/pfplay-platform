 ...
 *
 * <p><b>버그:</b> vcrew reconcile 스케줄러(60s)가 점검 중 {@link ActiveMaintenanceGate#isUnderMaintenance()}
 * 를 호출해 30s 스냅샷 캐시를 "true" 로 프라임한다. 운영자가 점검을 완료/취소하면
 * {@code MaintenanceEndedEvent} 의 AFTER_COMMIT 리스너({@code VirtualCrewMaintenanceListener} →
 ...
 */
class VirtualCrewMaintenanceGateEvictionIT extends AbstractIntegrationTest {
    ...
    void seed() {
        ...
        transactionTemplate.executeWithoutResult(status -> {
            PartyroomData p = PartyroomData.create(
                    "vcrew-gate", "intro", LinkDomain.of("link-vcrew-gate-" + System.nanoTime()),
