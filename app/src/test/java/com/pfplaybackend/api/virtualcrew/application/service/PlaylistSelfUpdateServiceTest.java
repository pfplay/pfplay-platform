...
import com.pfplaybackend.api.virtualcrew.application.service.ActiveDjSnapshotService.ActiveDjSnapshot;
import com.pfplaybackend.api.virtualcrew.application.service.ReactionScoreReader.ScoredLink;
...
class PlaylistSelfUpdateServiceTest {
    ...
    private final PartyroomVirtualCrewConfigRepository configRepository = mock(PartyroomVirtualCrewConfigRepository.class);
    ...
    private PartyroomVirtualCrewConfigData managedConfig(LocalDateTime watermark) {
        PartyroomVirtualCrewConfigData config = PartyroomVirtualCrewConfigData.create(ROOM);
    ...
    void configNotManaged_noOp() {
        PartyroomVirtualCrewConfigData off = PartyroomVirtualCrewConfigData.create(ROOM); // status=OFF
    ...
    void happyPath_swapAndWatermark() {
        ...
        ArgumentCaptor<PartyroomVirtualCrewConfigData> captor = ArgumentCaptor.forClass(PartyroomVirtualCrewConfigData.class);
