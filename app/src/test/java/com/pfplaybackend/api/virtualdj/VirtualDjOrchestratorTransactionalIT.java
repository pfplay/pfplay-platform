 ...
 * ({@link VirtualDjEventListenerIT} 와 동일 패턴).
 *
 ...
 */
class VirtualDjOrchestratorTransactionalIT extends AbstractIntegrationTest {
    ...
    void seed() {
        ...
        transactionTemplate.executeWithoutResult(status -> {
            PartyroomData p = PartyroomData.create(
                    "vdj-tx", "intro", LinkDomain.of("link-vdj-tx-" + System.nanoTime()),
